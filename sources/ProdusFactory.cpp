...
std::shared_ptr<Produs>
ProdusFactory::createProdus(TipProdus tip, const std::string& nume, double pret, int cantitate) {
	if (tip == MANCARE)
...
std::shared_ptr<Produs> ProdusFactory::createProdus(TipProdus tip, const std::string& nume, double pret,
                                                    const std::string& nume_mancare, int gramaj,
                                                    const std::string& nume_bautura, int volum, MarimeMeniu marime) {
	if (tip == MENIU)
